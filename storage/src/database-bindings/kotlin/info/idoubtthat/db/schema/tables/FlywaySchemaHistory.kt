...
import info.idoubtthat.db.schema.indexes.FLYWAY_SCHEMA_HISTORY_FLYWAY_SCHEMA_HISTORY_S_IDX
import info.idoubtthat.db.schema.keys.KEY_FLYWAY_SCHEMA_HISTORY_PRIMARY
...
open class FlywaySchemaHistory(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>citation.flyway_schema_history</code>
         */
    ...
    /**
     * The column <code>citation.flyway_schema_history.installed_rank</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.version</code>.
     */
    val VERSION: TableField<FlywaySchemaHistoryRecord, String?> = createField(DSL.name("version"), SQLDataType.VARCHAR(50), this, "")

    /**
     * The column <code>citation.flyway_schema_history.description</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.type</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.script</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.checksum</code>.
     */
    val CHECKSUM: TableField<FlywaySchemaHistoryRecord, Int?> = createField(DSL.name("checksum"), SQLDataType.INTEGER, this, "")

    /**
     * The column <code>citation.flyway_schema_history.installed_by</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.installed_on</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.execution_time</code>.
     */
    ...
    /**
     * The column <code>citation.flyway_schema_history.success</code>.
     */
    ...
    /**
     * Create an aliased <code>citation.flyway_schema_history</code> table
     * reference
     */
    ...
    /**
     * Create a <code>citation.flyway_schema_history</code> table reference
     */
